...
<body>
    ...
    <div id="main-wrapper">
        ...
        <header class="topbar" data-navbarbg="skin5">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="white">
    ...
    <script src="{{ asset('backend\matrix-admin-package-full\assets\libs\perfect-scrollbar\dist\perfect-scrollbar.jquery.min.js') }}"></script>
    <script src="{{ asset('backend\matrix-admin-package-full\assets\extra-libs\sparkline\sparkline.js') }}"></script>
    <!--Wave Effects -->
    <script src="{{ asset('backend\matrix-admin-package-full\dist\js\waves.js') }}"></script>
    <!--Menu sidebar -->
    <script src="{{ asset('backend\matrix-admin-package-full\dist\js\sidebarmenu.js') }}"></script>
    <!--Custom JavaScript -->
    <script src="{{ asset('backend\matrix-admin-package-full\dist\js\custom.min.js') }}"></script>
    <!-- this page js -->
    <script src="{{ asset('backend\matrix-admin-package-full\assets/extra-libs/multicheck/datatable-checkbox-init.js') }}"></script>
    <script src="{{ asset('backend\matrix-admin-package-full\assets/extra-libs/multicheck/jquery.multicheck.js') }}"></script>
    <script src="{{ asset('backend\matrix-admin-package-full\assets/extra-libs/DataTables/datatables.min.js') }}"></script>
    <script>
        /****************************************
         *       Basic Table                   *
         ****************************************/
